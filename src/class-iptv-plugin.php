...
function iptv_registrar_cadastros(){
  add_menu_page('IPTV', 'Cadastros IPTV', 'read', 'iptv-cad-tools', 'iptv_default_cad_page_display', 'dashicons-table-col-after', 30);
...
function iptv_registrar_relatorios(){
  add_menu_page('IPTV', 'Relatórios IPTV', 'read', 'iptv-rel-tools', 'iptv_default_rel_page_display', 'dashicons-media-text', 30);
  add_submenu_page('iptv-rel-tools', 'Pagamentos', 'Pagamentos', 'read', 'iptv-rel-pagamentos', 'iptv_pagamentos_rel_page_display');
